$(document).ready(function () {
  ...
  $("#favorite-sp").addClass("active-link");
});
...
function clickEvents() {
  $(".f-btn").click(function () {
    $.ajax({
      url: "/customer/markfavourite",
      type: "POST",
      data: {
        spId: $(this).attr("data-id"),
      },
      success: function (result) {
        window.location.href = "/customer/favouriteproviders";
      },
      error: function () {
        alert("error");
      },
  ...
  $(".uf-btn").click(function () {
    $.ajax({
      url: "/customer/markunfavourite",
      type: "POST",
      data: {
        spId: $(this).attr("data-id"),
      },
